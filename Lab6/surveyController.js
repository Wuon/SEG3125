...
module.exports = function (app) {
  ...
  app.get('/analysis', function (req, res) {
    var programmingLanguage = readData("programmingLanguage");
    var yoe = readData("yoe");
    var tabVSSpace = readData("tabVSSpace");
    var editor = readData("editor");
    var companies = readData("companies");
    var comments = readData("comments");
    res.render('showResults', { results: [programmingLanguage, yoe, tabVSSpace, editor, companies, comments] });
    console.log([programmingLanguage, yoe, tabVSSpace, editor, companies, comments]);
  });
  ...
  app.post('/niceSurvey', urlencodedParser, function (req, res) {
    ...
    for (var key in json) {
      ...
      if ((key === "editor") && (json[key].length === 2)) {
